...
class DeveloperService extends \CIP\services\BaseService {
	 ...
	 * @param string|null $language The target programming language for the generated source code. Possible values are: "csharp" (Default) Generate .net wrapper class source code. "java" Generate java wrapper class source code.
	 * @param string|null $table You may want to specify the table to generate C# wrapper class for. The default is "AssetRecords".
