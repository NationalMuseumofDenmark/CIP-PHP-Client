...
class BasePreviewService extends \CIP\services\BaseService {
	 ...
	 * @param string[optional] $previewname The name of a preview configured in the CIP server. By using named previews you can keep the actual preview parameters separate from the CIP client code. Every parameter that you specify explicitly in the URL replaces a corresponding value from the configured preview.
	 ...
	 * @param string[optional] $fallbackimageonerror Specifies whether the fallback image should be returned instead of the error message. Possible values are: "true" Return a fallback image instead of error message. The error is logged in the server log only. "false" (Default) - Do not use the fallback image, return the error message if any problem occurs.
	 * @param integer[optional] $version The number of the asset version to generate a preview for. A value of 0 represents the latest version. You can retrieve the list of available versions for an asset using the asset/getversions operation. Default is 0 (latest version).
	 ...
	 * @param string[optional] $cachecontrol Allow to control client cache policy switch for CIP operation results. This could lead to better performance in case the browser can use cached images. "no-cache" (Default) - Switch off caching of images in the browser. "clientdefault" Allow caching of images. The cache lifetime depend on constraint com.canto.cip.constraint.clientcachemaxage configuration. The default value is 3600 seconds (1 hour). See configuration section for details.
	 * @param string[optional] $fallbackimageonerror Specifies whether the fallback image should be returned instead of the error message. Possible values are: "true" Return a fallback image instead of error message. The error is logged in the server log only. "false" (Default) - Do not use the fallback image, return the error message if any problem occurs.
	 * @param integer[optional] $version The number of the asset version to generate a thumbnail for. A value of 0 represents the latest version. You can retrieve the list of available versions for an asset using the asset/getversions operation. Default is 0 (latest version).
	 * @param string[optional] $catalogname The DAM system catalog name e.g. Sample Catalog
	 * @return mixed The result does not have any contents. Returns true on success.
	 */
